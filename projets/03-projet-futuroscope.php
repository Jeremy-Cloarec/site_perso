        ...
        <section class="containerS ">
                <div class="titreAudessus">
                    <div class="descriptionW">
                        <h1>Futuroscope</h1>
                        <p class="technique">2022 | Figma</p>
                        <p class="description">Ce projet a été réalisé dans le cadre de ma formation à l'Ifocop. L'objectif était d'améliorer l'interface du site du Futuroscope en utilisant des styles et un système de design. </p>
                        <p class="description">Une partie importante de ce projet était la réservation sur la page d'accueil, où j'ai pu améliorer mes compétences en utilisant les composants et les animations de Figma. Cette section comprend notamment un calendrier cliquable et des options de réservation intégrées dans des accordéons.</p>
                    </div>
                </div>
                    ...
                    <div id="carousel1" class="carousel slide carrouselAll">
                        ...
                        <div class="carousel-inner carrouselShadow">
                            <div class="carousel-item active">
                                <img src="../assets/img/screenSite/futuroscope/futuroscop 1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/img/screenSite/futuroscope/futuroscop 2.jpg" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/img/screenSite/futuroscope/futuroscop 3.jpg" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/img/screenSite/futuroscope/futuroscop 4.jpg" class="d-block w-100">
                            </div>
                        </div>
